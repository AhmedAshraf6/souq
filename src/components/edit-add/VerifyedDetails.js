    ...
    <>
      ...
      <div className='row gx-5 gy-3'>
        ...
        <div className='col-md-6'>
          <h6 ref={adsNameRef}>اسم الإعلان</h6>
          <input
                ...
                return (
                  <label className='radio ms-5 my-1' key={ad.id}>
                    <input
                      ...
                      value={ad.id}
                      onChange={handleChange}
                      checked={formValues.adType == ad.id}
                    />
                    {ad.name_ar}
                    <span></span>
                  </label>
          ...
          <div className='radio-group'>
            <label className='radio ms-5 my-1'>
              <input
                ...
                value='cash'
                onChange={handleChange}
                checked={formValues.payment_option == 'cash'}
              />
              كاش
              <span></span>
            </label>
            <label className='radio ms-5 my-1'>
              <input
                ...
                value='exchange'
                onChange={handleChange}
                checked={formValues.payment_option == 'exchange'}
              />
              تبادل
              <span></span>
            </label>
            <label className='radio ms-5 my-1'>
              <input
                ...
                value='installments'
                onChange={handleChange}
                checked={formValues.payment_option == 'installments'}
              />
              أقساط
              <span></span>
            </label>
              ...
              <div className='radio-group'>
                <label className='radio ms-5 my-1'>
                  <input
                    ...
                    value='1'
                    onChange={handleChange}
                    checked={formValues.carStatus == '1'}
                  />
                  جديد
                  <span></span>
                </label>
                <label className='radio ms-5 my-1'>
                  <input
                    ...
                    value='0'
                    onChange={handleChange}
                    checked={formValues.carStatus == '0'}
                  />
                  مستعمل
                  <span></span>
                </label>
              ...
              <div className='radio-group'>
                <label className='radio ms-5 my-1'>
                  <input
                    ...
                    value='1'
                    onChange={handleChange}
                    checked={formValues.engineStatus == '1'}
                  />
                  مانيوال
                  <span></span>
                </label>
                <label className='radio ms-5 my-1'>
                  <input
                    ...
                    value='0'
                    onChange={handleChange}
                    checked={formValues.engineStatus == '0'}
                  />
                  أوتوماتيك
                  <span></span>
                </label>
